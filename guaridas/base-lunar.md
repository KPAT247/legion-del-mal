...
> ⚠️ **ALERTA: Problemas críticos que deben resolverse antes del lanzamiento de Glaciar-1.**

### Problema de oxígeno

El generador de oxígeno #2 opera al 60%. Con ambos generadores: capacidad para 12 personas. Con uno solo: máximo 6. Brainiac ha solicitado repuestos desde la Tierra; el envío tarda 3 semanas vía cohete de LexCorp.

### Comunicaciones intermitentes

La antena principal sufrió daño por micrometeoritos. Las comunicaciones con la Fortaleza Prohibida se cortan 2-5 veces al día. Los mensajes críticos se envían en ráfagas programadas cada 4 horas.

### Suministros

- Alimentos: 45 días (con 4 personas)
- Agua reciclada: estable
- Combustible para retorno de emergencia: 1 viaje

## Personal actual

| Miembro     | Rol                                         | Desde      |
| ----------- | ------------------------------------------- | ---------- |
| Dron B-7    | Técnico de mantenimiento (dron de Brainiac) | Permanente |
| Agente Nova | Ingeniera de ensamblaje satelital           | 2025-02-01 |
| Agente Cero | Seguridad                                   | 2025-02-01 |

_Brainiac se conecta remotamente a sus drones. Doctor Doom viaja cada 2 semanas para trabajar en el escudo mágico del satélite. Magneto visitó una vez para moldear la estructura del Glaciar-1._

## Ruta de evacuación

1. Cápsula de emergencia (capacidad: 4 personas) → aterrizaje en el Pacífico Sur
